      ...
      >
        <div className="max-w-[1600px] mx-auto mb-12">
          ...
          <p className="text-center text-textMute text-lg max-w-3xl mx-auto">
            Learn from epoch-making projects where sophisticated risk intelligence made the impossible possible
          </p>
        </div>
        ...
        <div className="text-center mt-8">
          <p className="text-sm text-textMute">
            ← Case studies: Where advanced risk management meets monumental ambition →
          </p>
        </div>
      </motion.section>
